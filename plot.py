...
plt.xlabel("Anos")
plt.ylabel("Manchas")
plt.title("Número de manchas Solares nos 10 primeiros anos.")
...
plt.xlabel("Anos")
plt.ylabel("Manchas")
plt.title("Número de manchas Solares nos 10 últimos anos.")
...
plt.xlabel("Anos")
plt.ylabel("Manchas")
plt.title("Número de manchas Solares nos 30 primeiros anos.")
